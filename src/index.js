...
const todo1 = new createTodo.Todo('Eat', 'Stuff your face', '2022-12-10', 'low', false, 1, 'Achieve enlightenment');
...
todayBtnLink.addEventListener('click', sideBarLinks.todayBtn);
